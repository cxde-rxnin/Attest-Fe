...
export function Lamp() {
  return (
    <div className="absolute mt-52 inset-0 flex items-start justify-center pt-0">
      <motion.div
        ...
        className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-blue-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top] mb-30"
      >
      ...
      <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-white mb-40"></div>
    </div>
  )
}